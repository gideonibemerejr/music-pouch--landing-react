      ...
      <div className='f5 f3-m lh-copy'>
        <div className='cf dt-l w-100 bt b--black-10 pv4'>
          ...
          <div className='dtc-l v-mid f6 f5-m f4-l measure-l'>
            <p className='measure pv4-l center'>
              ...
              afterwards, the developer left San Francisco and claimed insurance
              money.
            </p>
          </div>
        </div>
        <div className='cf dn'>
          <div className='fl w-100 w-50-l'>
            <p className='f5 pv4'>
              During high tides, water would flow directly into the pools from
              the nearby ocean, recycling the{' '}
              <span className='db f4 f3-m f1-l fw6 measure lh-title'>
                two million US gallons of water in about an hour.{' '}
              </span>
            </p>
          </div>
          <div className='fl w-100 w-50-l'>
            <p className='f5'>
              During low tides, a powerful turbine water pump, built inside a
              cave at sea level, could be switched on from a control room and
              could fill the tanks at a rate of 6,000 US gallons a minute,
